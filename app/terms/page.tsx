      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <div className="prose prose-stone dark:prose-invert max-w-none space-y-6">
            ...
            <p>
              These Terms of Service govern your use of {appConfig.name}, a text
              analysis tool accessible from{' '}
              {new URL(appConfig.url.production).hostname}. By using our
              website, you accept these terms in full. If you disagree with any
              part of these terms, you must not use our website.
            </p>

            <h2 className="text-2xl font-semibold">Use License</h2>
            <p>
              Permission is granted to temporarily use {appConfig.name} for
            ...
            <p>
              {appConfig.name} is provided &ldquo;as is&rdquo; without any
            ...
            <p>
              In no event shall {appConfig.name} be liable for any damages
              (including, without limitation, damages for loss of data or
              profit, or due to business interruption) arising out of the use or
              inability to use {appConfig.name}, even if we have been notified
